export const jobsData = [
  ...
  // External job listings from various platforms
  {
    id: 9,
    ...
    description: "Analyze complex datasets to drive product insights and business strategy. Work with cross-functional teams.",
    companyRating: 4.5,
    isRemote: false,
    category: "Data Analysis",
    source: "LinkedIn",
  ...
  },
  {
    ...
    salary: "₹28-40 LPA",
    postedDate: "2024-01-15",
    skills: ["Python", "Machine Learning", "Azure ML", "Deep Learning", "TensorFlow", "Computer Vision"],
    description: "Build and deploy machine learning models for intelligent cloud services and applications.",
    companyRating: 4.6,
    isRemote: true,
    category: "Data Science",
    source: "Naukri",
    externalUrl: "https://www.naukri.com/job-listings/microsoft-data-scientist"
  },
  {
    id: 11,
    ...
    salary: "₹45-60 LPA",
    postedDate: "2024-01-14",
    skills: ["Apache Spark", "AWS", "Python", "Scala", "Redshift", "EMR", "Glue"],
    description: "Design and build large-scale data processing systems. Lead a team of data engineers.",
    companyRating: 4.3,
    isRemote: false,
    category: "Data Engineering",
    source: "LinkedIn",
  ...
  },
  {
    ...
    salary: "₹32-45 LPA",
    postedDate: "2024-01-13",
    skills: ["Deep Learning", "Computer Vision", "PyTorch", "Python", "Research", "NLP"],
    description: "Research and develop cutting-edge ML algorithms for creative cloud products.",
    companyRating: 4.4,
    isRemote: true,
    category: "Machine Learning",
    source: "Naukri",
    externalUrl: "https://www.naukri.com/job-listings/adobe-ml-researcher"
  }
];
